...
```
 ...
 This histogram represents a scenario where the number of species varies per year, but there's no trend (increasing or decreasing) in he number naturalizing over time.
