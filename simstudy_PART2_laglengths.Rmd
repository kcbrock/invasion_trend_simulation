...
<!-- changepoint::cpts(a2) + (as.numeric(accumulated_A$Year[[1]]) - 1) -->
...
<!-- ```{r} -->
<!-- selectedcp = 1 -->
<!-- #changepoint::plot(b1, cpt.width = 4, col = "black", cpt.col = "blue", ylab = "# of Taxa Vouchered", xlab = "Years (since beginning of time window)") -->
<!-- changepoint::plot(b1, ncpts = selectedcp) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- selectedcp = 1 -->
<!-- #changepoint::plot(c1, cpt.width = 4, col = "black", cpt.col = "blue", ylab = "# of Taxa Vouchered", xlab = "Years (since beginning of time window)") -->
<!-- changepoint::plot(c1, ncpts = selectedcp) -->
<!-- ``` -->
...
ggsave(filename = "ExpDecayDPlags.png", device = "png", scale = 1, width =6, dpi = 600)
```
