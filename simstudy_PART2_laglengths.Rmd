...
```{r}
#plot(Taxa_Vouchered ~ Year, data = accumulated_A)
#abline(v = 1939, col = "red")
#abline(v = 1998, col = "red")
```


I wonder if this indicates that I should use changepoint.np ? The non-para one?  I'll deal with that when it gets published.
