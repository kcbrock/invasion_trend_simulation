...
<!-- ``` -->
<!-- ```{r} -->
<!-- changepoint::cpts.full(b1) + (accumulated_B$Year[1] -1) -->
<!-- ``` -->
<!-- ```{r} -->
<!-- firstrow = 4 -->
<!-- secondrow = firstrow +1 -->
...
<!-- chpoints <- c( 0, changepoint::cpts(b2), nrow(accumulated_B))  -->
<!-- chpoints -->
<!-- chpoints + accumulated_B$Year[1] -->
<!-- segmeans <- changepoint::param.est(b2)$mean -->
<!-- segmeans -->
<!-- segvars <- (changepoint::param.est(b2)$variance) -->
<!-- sqrt(segvars) -->
<!-- ``` -->
<!-- ```{r} -->
<!-- seg1wmean <- segmeans[1]* (chpoints[2]- chpoints[1]) -->
...
<!-- print("ending seg length, mean, std:") -->
<!-- nrow(accumulated_B) - chpoints[endptindex] -->
<!-- round(sum(segwmeans[endptindex:length(segwmeans)]) / (chpoints[length(chpoints)]- chpoints[endptindex]), 2) -->
<!-- round(sqrt(sum(segwvars[endptindex:length(segwvars)]) / (chpoints[length(chpoints)]- chpoints[endptindex])), 2) -->
<!-- ``` -->
<!-- ```{r} -->
<!-- changepoint::plot(b2, type='p') -->
<!-- ``` -->
