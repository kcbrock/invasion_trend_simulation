...
#accumulated <- subset(accumulated, Year != 1920)
accumulated
```
...
<!--   labs(title = "Constant Lag Scenario", x = "Year", y = "Number of Species") -->
...
allthemeans <- as.data.frame(seq(from = 10, to = 1, length.out = nrow(alltheyears))) 
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
  ...
  scale_x_continuous(breaks = c(1900, 1920, 1940, 1960, 1980, 2000, 2020)) +
   guides(colour = guide_legend(reverse=T)) +
 theme_classic() +
  labs(title = "Continuous Shortening of Data Processing Lags", x = "Year", y = "Number of Species")
ggsave(filename = "ContshorteningDPlags.png", device = "png", scale = 1, width =6, dpi = 600)
```
