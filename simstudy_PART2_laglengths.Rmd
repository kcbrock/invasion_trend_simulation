...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
  ...
  labs(title = "Data Processing Lags Shorten \n Over Time", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "DPlagsshorten.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
# steady decline
allthemeans <- as.data.frame(seq(from = 0.083, to = 10, length.out = nrow(alltheyears)))
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
  ...
  theme_light() +
  theme(legend.title=element_blank(), legend.position = "none", panel.border = element_blank()) +
  labs(title = "Data Processing Lags Lengthen \n Over Time", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "DPlagslengthen.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
theme_light() +
  theme(legend.title=element_blank(), legend.position = "none", panel.border = element_blank()) +
  labs(title = "Field Surveying Lags Shorten \n Over Time", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "SteadyShortenFieldLags.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
theme_light() +
  theme(legend.title=element_blank(), legend.position = "none", panel.border = element_blank()) +
  labs(title = "Field Surveying Lags Lengthen \n Over Time", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "SteadylengthenFieldLags.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
<!-- chpoints <- c( 0, changepoint::cpts(b2), nrow(accumulated_B)) -->
<!-- chpoints -->
<!-- chpoints + as.numeric(accumulated_B$Year[1]) -->
<!-- segmeans <- changepoint::param.est(b2)$mean -->
<!-- segmeans -->
<!-- segvars <- (changepoint::param.est(b2)$variance) -->
<!-- segvars -->
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_light() +
  theme(legend.title=element_blank(), legend.position = "none", panel.border = element_blank()) +
  labs(title = "Field Surveying & Data Processing \n Lags Shorten Over Time", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "FSandDP_steadyshorten.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
ggsave(filename = "FSandDP_steadylengthen.png", device = "png", scale = 1, width =4, dpi = 600)
```