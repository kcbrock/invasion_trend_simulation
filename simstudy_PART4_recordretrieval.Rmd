...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_light() +
  ...
  labs(title = "50% of Naturalized Records Retrieved", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "50natrecordsretreived.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_light() +
  theme(legend.position = "none",panel.border = element_blank(),legend.title=element_blank()) +
  labs(title = "85% of Naturalized Records Retrieved", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "85natrecordretreived.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_light() +
  theme(legend.position = "none",panel.border = element_blank(),legend.title=element_blank()) +
  labs(title = "Higher Record Retrieval \n in Recent Years", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "lowearlyhighlater.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
sim_spp13$Voucher_Year <- sim_spp13$Naturalization_Year + Nat_Detect_Lag$Nat_Detect_Lag + Detect_Vouch_Lag$Detect_Vouch_Lag
sim_spp13$ID_Year <- sim_spp13$Naturalization_Year + Nat_Detect_Lag$Nat_Detect_Lag + Detect_Vouch_Lag$Detect_Vouch_Lag + Vouch_ID_Lag$Vouch_ID_Lag
sim_spp13$Report_Year <- sim_spp13$Naturalization_Year + Nat_Detect_Lag$Nat_Detect_Lag + Detect_Vouch_Lag$Detect_Vouch_Lag + Vouch_ID_Lag$Vouch_ID_Lag + ID_Report_Lag$ID_Report_Lag


sim_spp13$Compile_Year <- sim_spp13$Naturalization_Year + Nat_Detect_Lag$Nat_Detect_Lag + Detect_Vouch_Lag$Detect_Vouch_Lag + Vouch_ID_Lag$Vouch_ID_Lag + ID_Report_Lag$ID_Report_Lag + Report_Compile_Lag$Report_Compile_Lag
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_light() +
  theme(legend.position = "none",panel.border = element_blank(),legend.title=element_blank()) +
  labs(title = "Lower Record Retrieval \n in Recent Years", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "highearlylowlater.png", device = "png", scale = 1, width =4, dpi = 600)
```
50% retrieval from 1920-1970, 85% from 1970 - 2020