...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_classic() +
  theme(legend.title=element_blank()) +
  labs(title = "67% of naturalized records retrieved", x = "Year", y = "Number of Species")
ggsave(filename = "67natrecordretreived", device = "png", scale = 1, width =6, dpi = 600)
```
