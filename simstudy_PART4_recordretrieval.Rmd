...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_light() +
  ...
  labs(title = "E: 50% of Naturalized Records Retrieved", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "Fig4_50natrecordsretreived.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_light() +
  theme(legend.position = "none",panel.border = element_blank(),legend.title=element_blank()) +
  labs(title = "D: 85% of Naturalized Records Retrieved", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "Fig4_85natrecordretreived.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
# Scenario 12: Mixed data: 50% retrieval from 1920-1970, 85% from 1970 - 2020
...
# Scenario 1??: Mixed data: 85% retrieval from 1920-1970, 50% from 1970 - 2020
