...
ggsave(filename = "Fig4_HP_ided_specimens.png", device = "png", scale = 1, width =4, dpi = 600)
```
...
ggsave(filename = "Fig4_HarvPt_reports.png", device = "png", scale = 1, width =4, dpi = 600)
```
