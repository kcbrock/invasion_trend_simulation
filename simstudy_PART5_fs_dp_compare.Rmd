...
```{r}
changepoint::plot(a2, type = "p", pch = 1, cex = 1.25, cpt.width = 3, col = "red", cpt.col = "black", ylab = "Naturalization Rate (spp/year) ", xlab = "Time (Years Since Beginning of Analysis Window)")
...
ggplot(DATA, aes(x=as.numeric(Year), y=as.numeric(accumulated_species), group = Analysis_Type, color = Analysis_Type)) +
 ...
 theme_classic() +
  ...
  labs( title = "No Lags Exist", x = "Year", y = "Total Naturalized Species")
...
```{r}
changepoint::plot(a2, type = "p", pch = 1, cex = 1.25, cpt.width = 3, col = "red", cpt.col = "black", ylab = "Naturalization Rate (spp/year) ", xlab = "Time (Years Since Beginning of Analysis Window)")
text(x=12, y=0, "0 +/- 0", , cex = 1, font = 2)
text(x=28.5, y=3.25,  "2.47 +/- 1.54", cex = 1, font = 2)
text(x=53, y=10.75, "9.96 +/- 3.69", cex = 1, font = 2)
```
