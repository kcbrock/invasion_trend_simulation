...
accumulated_A$usedate <- "Data from Seebens et al."
accumulated_B$usedate <- "Adjusted Data from Seebens et al."
...
#  scale_x_continuous(breaks = c(1900, 1920, 1940,  1960, 1980, 2000, 2020)) +
 ...
 theme_light() +
  ...
  labs( title = "", x = "Year", y = "Total Naturalized Species")
ggsave(filename = "both.png", device = "png", scale = 1, width =6, dpi = 600)
...
breaks <- c(1905, 1910,  1915, 1920, 1925, 1930, 1935, 1940, 1945, 1950,  1955, 1960,  1965, 1970,  1975, 1980, 1985, 1990, 1995, 2000, 2005)
labels = c( "1910",  "1915", "1920", "1925", "1930", "1935", "1940", "1945", "1950",  "1955", "1960",  "1965", "1970",  "1975", "1980", "1985", "1990", "1995", "2000", "2005")
